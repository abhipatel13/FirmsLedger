...
VALUES
  ...
  (gen_random_uuid(), NULL, 'Construction', 'construction',
   'Builders, contractors, and construction service providers.', 'hard-hat', 9, true),
  (gen_random_uuid(), NULL, 'Manufacturing', 'manufacturing',
   'Factories, industrial producers, and precision machining.', 'factory', 18, true),
